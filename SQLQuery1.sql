...
--city
BULK INSERT city
FROM 'C:\Users\Navya\Downloads\city.csv'
	WITH 
	(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
...
FROM 'C:\Users\Navya\Downloads\archive (15)\products.csv'
	WITH 
	(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
...
FROM 'C:\Users\Navya\Downloads\archive (15)\customers.csv'
	WITH 
	(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
...
SET DATEFORMAT dmy
BULK INSERT sales
FROM 'C:\Users\Navya\Downloads\archive (15)\sales.csv'
	WITH 
	(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
...
SELECT city_name,FORMAT((population*0.25),'N0') AS estimated_coffee_consumers
FROM city
...
SELECT city_name,SUM(total) AS revenue_generated,
...
(rent_table.estimated_rent/city_table.count_of_customers) AS avg_rent_per_customer
FROM city_table
...
SELECT
      ...
      month_sale,
      monthly_revenue,
      LAG(monthly_revenue) OVER (PARTITION BY city_name ORDER BY year_sale,month_sale) AS previous_month_sale
FROM monthly_sales
)
SELECT
city_name,
...
monthly_revenue,
previous_month_sale,
ROUND(((monthly_revenue-previous_month_sale) / previous_month_sale ) *100.0,2) AS Sales_growth_rate
FROM previous_month
